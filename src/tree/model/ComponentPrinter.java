...
public class ComponentPrinter implements Printable {
	...
	public int print(Graphics g, PageFormat pF, int pageIndex)
		...
		try {
			...
			System.out.println("Comp Pref Height " + compHeight
					+ " Comp Pref Width " + compWidth);
			System.out.println("Pageheight " + paperHeight + " PageWidth "
					+ paperWidth + " Heightcounter " + heightCounter);

			g.translate((int) pF.getImageableX(), (int) pF.getImageableY());

			Graphics2D g2 = (Graphics2D) g;
			g2.setBackground(Color.WHITE);
			g.translate((int) -(paperWidth * widthCounter),
					(int) -(paperHeight * heightCounter));
			comp.paint(g);
			return PAGE_EXISTS;
		} finally {
	...
	public static void doPrint(Component comp, boolean landscape)
			throws PrinterException {
