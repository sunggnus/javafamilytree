...
public class TreeCanvas extends JPanel implements ExportImage {
	...
	/**
	 * if this boolean is true the grid coordinates of the persons are written
	 * within a person node
	 */
	 ...
	 * 
	 * @param heightUnit
	 *            the initial height of a person node
	 * @param widthUnit
	 *            the initial width of a person node
	 * @param scaling
	 *            a scaling factor used for drawing 1.0 should be used as
	 *            default
	 */
	public TreeCanvas(int heightUnit, int widthUnit, double scaling) {
		...
		TreeCanvasMouseListener canvasMouseListener = new TreeCanvasMouseListener(
				this);
	 ...
	 * 
	 * @param x
	 *            the value by which {@link #prefX} will be increased
	 */
	 ...
	 * 
	 * @param y
	 *            the value by which {@link #prefY} will be increased
	 */
