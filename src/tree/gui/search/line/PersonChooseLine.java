...
public class PersonChooseLine extends AbstractPersonLine {
	 ...
	 * @param view
	 */
	public PersonChooseLine(final Person person, final Person caller,
			final int mode, final AbstractOverview view) {
		super(person, view);
		this.setMulti(this.getMulti() + 1);

		choose = new JButton(Main.getTranslator().getTranslation("choose",
	...
	public void setMainSize(int width) {
		this.setMainSize(width, (int) this.choose.getPreferredSize()
				.getHeight());
	}
