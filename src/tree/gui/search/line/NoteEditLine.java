...
public class NoteEditLine extends AbstractLine {
	...
	public NoteEditLine(final Note note, final AbstractOverview view) {
		...
		this.edit = new JButton(Main.getTranslator().getTranslation("editNote",
				Translator.LanguageFile.OVERVIEW_DIALOG));
		this.delete = new JButton(Main.getTranslator().getTranslation(
				"removeNote", Translator.LanguageFile.OVERVIEW_DIALOG));
