...
public class MainFrame extends JFrame {
	...
	public MainFrame() {
		...
		this.setTitle(Main.getTranslator().getTranslation("title",
				Translator.LanguageFile.MAIN_FRAME));
		this.setJMenuBar(new MenuBar());
		canvas = new TreeCanvas(Config.PERSON_HEIGHT, Config.PERSON_WIDTH,
				Config.SCALING);
		...
		final EntryField xCoordinate = new EntryField("X: ",
				AbstractField.DEFAULT_LABEL_WIDTH, width);
		xCoordinate.setContent("-1");
		final EntryField yCoordinate = new EntryField("Y: ",
				AbstractField.DEFAULT_LABEL_WIDTH, width);
		yCoordinate.setContent("-1");

		widthUnit = new EntryField(Main.getTranslator().getTranslation(
				"defaultWidth", Translator.LanguageFile.MAIN_FRAME),
				AbstractField.DEFAULT_LABEL_WIDTH, width);
		widthUnit.setContent(String.valueOf(Config.PERSON_WIDTH));

		heightUnit = new EntryField(Main.getTranslator().getTranslation(
				"defaultHeight", Translator.LanguageFile.MAIN_FRAME),
				AbstractField.DEFAULT_LABEL_WIDTH, width);
	...
	public void changeLanguage() {
		...
		this.setTitle(Main.getTranslator().getTranslation("title",
				Translator.LanguageFile.MAIN_FRAME));
		this.heightUnit.setLabelText(Main.getTranslator().getTranslation(
				"defaultHeight", Translator.LanguageFile.MAIN_FRAME));
		this.widthUnit.setLabelText(Main.getTranslator().getTranslation(
				"defaultWidth", Translator.LanguageFile.MAIN_FRAME));
		size.refreshSize();
		this.revalidate();
