...
public class EditPersonDialog extends JDialog {
	...
	private void construct(boolean addPerson) {
		...
		if (!addPerson) {
			this.editablePerson = (Person) javax.swing.JOptionPane
					.showInputDialog(
							this,
							Main.getTranslator().getTranslation("choosePerson",
									Translator.LanguageFile.EDIT_PERSON_DIALOG),
							Main.getTranslator().getTranslation("editPerson",
									Translator.LanguageFile.EDIT_PERSON_DIALOG),
							javax.swing.JOptionPane.NO_OPTION, null, Main
									.getMainNode().getPersons().toArray(),
		...
		givenName = new EntryField(Main.getTranslator().getTranslation(
				"givenName", Translator.LanguageFile.EDIT_PERSON_DIALOG),
				AbstractField.DEFAULT_LABEL_WIDTH);
		familyName = new EntryField(Main.getTranslator().getTranslation(
				"familyName", Translator.LanguageFile.EDIT_PERSON_DIALOG),
				AbstractField.DEFAULT_LABEL_WIDTH);
		birthName = new EntryField(Main.getTranslator().getTranslation(
				"birthName", Translator.LanguageFile.EDIT_PERSON_DIALOG),
				AbstractField.DEFAULT_LABEL_WIDTH);
		location = new EntryField(Main.getTranslator().getTranslation(
				"location", Translator.LanguageFile.EDIT_PERSON_DIALOG),
				AbstractField.DEFAULT_LABEL_WIDTH);
		trade = new EntryField(Main.getTranslator().getTranslation("trade",
				Translator.LanguageFile.EDIT_PERSON_DIALOG),
				AbstractField.DEFAULT_LABEL_WIDTH);

		commentOne = new EntryField(Main.getTranslator().getTranslation(
				"comment", Translator.LanguageFile.EDIT_PERSON_DIALOG),
				AbstractField.DEFAULT_LABEL_WIDTH);
		xPosition = new EntryField(Main.getTranslator().getTranslation("relX",
				Translator.LanguageFile.EDIT_PERSON_DIALOG),
				AbstractField.DEFAULT_LABEL_WIDTH);
		xPosition.setToolTip(Main.getTranslator().getTranslation("relX_tool",
				Translator.LanguageFile.EDIT_PERSON_DIALOG));
		dateOfBirth = new EntryField(Main.getTranslator().getTranslation(
				"dateOfBirth", Translator.LanguageFile.EDIT_PERSON_DIALOG),
				AbstractField.DEFAULT_LABEL_WIDTH);
		dateOfDeath = new EntryField(Main.getTranslator().getTranslation(
				"dateOfDeath", Translator.LanguageFile.EDIT_PERSON_DIALOG),
				AbstractField.DEFAULT_LABEL_WIDTH);
		sex = new DropDownField<String>(Main.getTranslator().getTranslation(
				"sex", Translator.LanguageFile.EDIT_PERSON_DIALOG),
				AbstractField.DEFAULT_LABEL_WIDTH);
		sex.add(Main.getTranslator().getTranslation("male",
				Translator.LanguageFile.EDIT_PERSON_DIALOG));
		sex.add(Main.getTranslator().getTranslation("female",
				Translator.LanguageFile.EDIT_PERSON_DIALOG));
			...
			public void itemStateChanged(ItemEvent e) {
				if (e.getStateChange() == ItemEvent.SELECTED
					...
					editablePerson.setSex(((String) sex.getSelectedItem())
							.equals(Main.getTranslator().getTranslation(
									"female",
									Translator.LanguageFile.EDIT_PERSON_DIALOG)) ? Sex.FEMALE
							: Sex.MALE);
		...
		alive = new ModifiedCheckBox(Main.getTranslator().getTranslation(
				"alive", Translator.LanguageFile.EDIT_PERSON_DIALOG),
				AbstractField.DEFAULT_LABEL_WIDTH);
		...
		mother = new PersonEditField(editablePerson,
				PersonEditField.MODE_MOTHER);
		father = new PersonEditField(editablePerson,
				PersonEditField.MODE_FATHER);
		accept = new JButton(Main.getTranslator().getTranslation(
				"generatePerson", Translator.LanguageFile.EDIT_PERSON_DIALOG));
		...
		accept.setMinimumSize(new Dimension(AbstractField.DEFAULT_WIDTH,
				(int) accept.getMinimumSize().getHeight()));
		...
		ModifiedJButton loadImage = new ModifiedJButton(Main.getTranslator()
				.getTranslation("loadImage",
						Translator.LanguageFile.EDIT_PERSON_DIALOG), -10,
				AbstractField.DEFAULT_LABEL_WIDTH);
		ModifiedJButton deleteImage = new ModifiedJButton(Main.getTranslator()
		...
		loadImage.getJButton().addActionListener(
				new ImageLoaderDialog(pictureContent));
		...
		ModifiedJButton visibleParents = new ModifiedJButton(Main
				.getTranslator().getTranslation("visibleParents",
						Translator.LanguageFile.EDIT_PERSON_DIALOG), -10,
				AbstractField.DEFAULT_LABEL_WIDTH);
		...
		ModifiedJButton invisibleParents = new ModifiedJButton(Main
				.getTranslator().getTranslation("invisibleParents",
						Translator.LanguageFile.EDIT_PERSON_DIALOG), -10,
				AbstractField.DEFAULT_LABEL_WIDTH);
		...
		ModifiedJButton visibleChildren = new ModifiedJButton(Main
				.getTranslator().getTranslation("visibleChildren",
						Translator.LanguageFile.EDIT_PERSON_DIALOG), -10,
				AbstractField.DEFAULT_LABEL_WIDTH);
		...
		ModifiedJButton invisibleChildren = new ModifiedJButton(Main
				.getTranslator().getTranslation("invisibleChildren",
						Translator.LanguageFile.EDIT_PERSON_DIALOG), -10,
				AbstractField.DEFAULT_LABEL_WIDTH);
		...
		picturePanel.setPreferredSize(new Dimension(maxwidth + 10,
				(int) picturePanel.getPreferredSize().getHeight()));
		for (Component comp : picturePanel.getComponents()) {
			if (comp instanceof ModifiedJButton) {
				ModifiedJButton but = (ModifiedJButton) comp;
				but.getJButton().setPreferredSize(
						new Dimension(maxwidth, (int) comp.getPreferredSize()
								.getHeight()));
				but.getJButton().setMaximumSize(
						new Dimension(maxwidth, (int) comp.getPreferredSize()
								.getHeight()));
			}
			comp.setMinimumSize(new Dimension(maxwidth, (int) comp
	...
	private void ini() {
		if (this.editablePerson == null) {
			...
			this.editablePerson = new Person(
					givenName.getContent(),
					familyName.getContent(),
	...
	private int[] readDate(String txt) throws InvalidInputException {
		...
		InvalidInputException exp = new InvalidInputException(Main
				.getTranslator().getTranslation("invalidInput",
						Translator.LanguageFile.EDIT_PERSON_DIALOG));
	...
	public void saveData() {
		try {
			...
			editablePerson
					.setSex(((String) sex.getSelectedItem())
							.equals(Main.getTranslator().getTranslation(
									"female",
									Translator.LanguageFile.EDIT_PERSON_DIALOG)) ? Sex.FEMALE
							: Sex.MALE);
			...
			javax.swing.JOptionPane.showMessageDialog(
					this,
					Main.getTranslator().getTranslation("validX",
							Translator.LanguageFile.EDIT_PERSON_DIALOG));
		}
	}
	...
	public void loadData() {
		...
		this.dateOfBirth.setContent(Utils
				.calendarToSimpleString(this.editablePerson.getBirthdate()));
		this.dateOfDeath.setContent(Utils
				.calendarToSimpleString(this.editablePerson.getDeathdate()));
		this.alive.setSelected(this.editablePerson.isAlive());
		this.visible.setSelected(this.editablePerson.isVisible());
		this.sex.setSelectedItem(this.editablePerson.isFemale() ? Main
				.getTranslator().getTranslation("female",
						Translator.LanguageFile.EDIT_PERSON_DIALOG) : Main
				.getTranslator().getTranslation("male",
						Translator.LanguageFile.EDIT_PERSON_DIALOG));
		this.father.setOwner(this.editablePerson);
		this.mother.setOwner(this.editablePerson);
		this.xPosition.setContent(String.valueOf(this.editablePerson
				.getXPosition()));
