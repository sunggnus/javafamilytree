...
public class EnterFilePathField extends AbstractField {
	...
	public EnterFilePathField() {
		...
		defaultSearch = new JLabel(Main.getTranslator().getTranslation(
				"defaultSearch", Translator.LanguageFile.OPTION_DIALOG));

		text = new JTextField();
		text.setText(Config.DEFAULT_PATH);
		text.setMinimumSize(new Dimension(AbstractField.EMPTY_TEXT_FIELD_WIDTH,
		...
		edit = new JButton(Main.getTranslator().getTranslation("edit",
		...
		edit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (text.isEditable()) {
					edit.setText(Main.getTranslator().getTranslation("save",
							Translator.LanguageFile.OPTION_DIALOG));
				} else {
					edit.setText(Main.getTranslator().getTranslation("edit",
							Translator.LanguageFile.OPTION_DIALOG));
				}
			}
		...
		search = new JButton(Main.getTranslator().getTranslation("search",
				Translator.LanguageFile.OPTION_DIALOG));
	...
	public void increaseLabelWidth(int width) {
		...
		JButton toDetermineMinEdit = new JButton(Main.getTranslator()
				.getTranslation("save", Translator.LanguageFile.OPTION_DIALOG));
		if (toDetermineMinEdit.getMinimumSize().getWidth() > edit
		...
		int neccessaryMin = 5
				+ width
				- pos
				- (int) (edit.getMinimumSize().getWidth() + search
						.getMinimumSize().getWidth());
