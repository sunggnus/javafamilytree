...
public final class Translator {
	...
	/**
	 * the used {@link ResourceBundle.Control}
	 * it reads UTF-8 formated property files see {@link ResourceBundleControl}
	 */
	...
	public enum LanguageFile{
		...
		EDIT_NOTE_DIALOG("EditNoteJDialog"),
		EDIT_PERSON_DIALOG("EditPersonJDialog"),
		OPTION_DIALOG("OptionJDialog"),
		OVERVIEW_DIALOG("OverviewJDialog"),
		HELP("Help");
		...
		public String getTranslation(String key){
			...
			return this.resourceBundle.getString(key);
				...
				System.out.println("Resource not found " + key + " in " + this.name() );
				return "err: missing String: " + key;
			}
		}
		
		/**
		 * loads new localization data like
		 * e.g. language data
		 * @param loc the {@link Locale} which will be loaded
		 * @param path the path to the language data directory
		 * @throws MissingResourceException if no localization file was found
		 */
		public void loadLocale(Locale loc, String path) throws MissingResourceException{
				 resourceBundle = ResourceBundle.getBundle(path + fileName,loc,CONTROL);			
		}
	...
	/**
	 * loads new localization data like e.g. language data
	 * @param lang the language String of the {@link Locale} e.g. de
	 * @param country the country String of the {@link Locale} e.g. DE
	 */
	...
	/**
	 * loads new localization data like e.g. language data
	 * this method is usually only called internally
	 * @param loc the {@link Locale} which will be loaded
	 * @param path the path to the directory where it will be searched for localization data
	 */
	 ...
	 * @param path the string where the symbols should be replaced
	 ...
	 * @param source the corresponding {@link LanguageFile}
	 * @return
	 */
