...
public enum OptionList {
	...
	FIXED_PERSON_DATA_POSITIONS("Personeninformationen stehen immer in der selben H�he",OptionList.TYPE_PERSON_POSITION_DATA_MODE),
	FLOW_PERSON_DATA_POSITIONS("Personeninformationen werden b�ndig angeordnet",OptionList.TYPE_PERSON_POSITION_DATA_MODE),
	...
	public static void translate(){
		for(OptionList b : OptionList.values()){
			b.description = Main.getTranslator().getTranslation(b.name(), Translator.LanguageFile.OPTION_DIALOG);
		}
	}
